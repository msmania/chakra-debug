...
#define TARGET_32
#define BUCKETIZE_MEDIUM_ALLOCATIONS
typedef uint32_t uint;
typedef uint16_t ushort;

struct AutoSystemInfo {
...
{
public:
  static const char *type() { return "SmallAllocationBlockAttributes"; }
...
{
public:
  static const char *type() { return "MediumAllocationBlockAttributes"; }
...
{
public:
  static const char *type() { return "LargeAllocationBlockAttributes"; }
    // This is there for RecyclerSweep to distinguish which bucket index to use
    static const bool IsSmallBlock = false;
    static const bool IsMediumBlock = false;
